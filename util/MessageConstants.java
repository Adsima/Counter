...
public final class MessageConstants {
    public static final String GREETINGS_STRING = "Приветсвую!!!";
    // Enter value
    public static final String VALUE_ELECTRICITY_COUNTER = "Введите показание счетчика электричество: ";
    ...
    public static final String INCORRECT_VALUE_TEMPLATE = "Ошибка. Некорректное значение %s";
    // Exit
    public static final String KEY_WORD = "exit";
}
